...
const TourismConfidence = ({ pathName }) => {
  ...
  return (
    <Card pathName={pathName} cardName='confidence' cols='1'>
      <CardHeading cardPath="/confidence" cardTitle="Tourism Confidence" pathName={pathName} iconType="IconTourismConfidence" cardSubtitle="Measures local sentiment towards tourism" />
      <div
        id="confidenceChart"
